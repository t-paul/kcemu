...
case OUT_xC_B: OutZ80(R->BC.B.l|(R->BC.B.h<<8),R->BC.B.h);break;
case OUT_xC_C: OutZ80(R->BC.B.l|(R->BC.B.h<<8),R->BC.B.l);break;
case OUT_xC_D: OutZ80(R->BC.B.l|(R->BC.B.h<<8),R->DE.B.h);break;
case OUT_xC_E: OutZ80(R->BC.B.l|(R->BC.B.h<<8),R->DE.B.l);break;
case OUT_xC_H: OutZ80(R->BC.B.l|(R->BC.B.h<<8),R->HL.B.h);break;
case OUT_xC_L: OutZ80(R->BC.B.l|(R->BC.B.h<<8),R->HL.B.l);break;
case OUT_xC_A: OutZ80(R->BC.B.l|(R->BC.B.h<<8),R->AF.B.h);break;

case INI:
  WrZ80(R->HL.W++,InZ80(R->BC.B.l|(R->BC.B.h<<8)));
  R->BC.B.h--;
...
case OUTI:
  R->BC.B.h--;
  OutZ80(R->BC.B.l|(R->BC.B.h<<8),RdZ80(R->HL.W++));
  R->AF.B.l=N_FLAG|(R->BC.B.h? 0:Z_FLAG);
  break;
