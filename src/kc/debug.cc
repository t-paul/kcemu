...
/** bytes disassembled.                                     **/
/*************************************************************/
static int DAsm(char *S,word_t A)
{
...
/*************************************************************/
byte_t DebugZ80(_Z80 *R)
{
  static word_t last_word;
  char S[128],T[9];
  byte_t J,I;
  ...
  while(1)
  {
	...
	puts("t              : Display stack trace");
        puts("?,h            : Show this help text");
        puts("w              : Write core file");
	...
	puts("x              : Continue");
      ...
      case 'X':  R->Trace=0;return(1); 
      case 'Q':  return(0);
      case 'W':  memory->dumpCore();
	         break;
