 ...
 *
 *  $Id: ports1.cc,v 1.4 2002/06/09 14:24:33 torsten_paul Exp $
 *
...
void
Ports1::out(word_t addr, byte_t val)
{
  byte_t a = addr & 0xff;
...
void
Ports1::change_0x84(byte_t changed, byte_t val)
{
  if (changed & 0x01)
    {
...
void
Ports1::change_0x86(byte_t changed, byte_t val)
{
  if (changed & 0x01)
    {
