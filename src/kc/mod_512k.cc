...
Module512k::~Module512k(void)
{
}

int
Module512k::get_segment_index(word_t addr, byte_t val)
{
  return (val >> 2) & 0x1f;
}

word_t
Module512k::get_base_address(word_t addr, byte_t val)
{
  return (val & 0x80) ? 0x8000 : 0x4000;
}

ModuleInterface *
Module512k::clone(void)
{
  return new Module512k(*this);
}
