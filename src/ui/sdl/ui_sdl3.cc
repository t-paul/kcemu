 ...
 *
 *  $Id: ui_sdl3.cc,v 1.1 2002/06/09 14:24:34 torsten_paul Exp $
 *
...
void
UI_SDL3::update(bool full_update = false, bool clear_cache = false)
{
  generic_update();
...
void
UI_SDL3::memWrite(int addr, char val)
{
}
...
void
UI_SDL3::processEvents()
{
}

void
UI_SDL3::init(int *, char ***)
{
