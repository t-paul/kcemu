 ...
 *
 *  $Id: ui_beos3.cc,v 1.1 2002/06/09 14:24:34 torsten_paul Exp $
 *
...
void
UI_BeOS3::allocate_colors(double saturation_fg,
...
void
UI_BeOS3::update(bool full_update = false, bool clear_cache = false)
{
  generic_update();
...
void
UI_BeOS3::memWrite(int addr, char val)
{
}

void
UI_BeOS3::callback(void *data)
{
...
void
UI_BeOS3::flash(bool enable)
{
}

const char *
UI_BeOS3::get_title(void)
{
	return "BeKC - KC 85/3";
}

int
UI_BeOS3::get_width(void)
{
	return kcemu_ui_scale * get_real_width();
}

int
UI_BeOS3::get_height(void)
{
	return kcemu_ui_scale * get_real_height();
}

void
UI_BeOS3::reset(bool power_on = false)
{
  z80->addCallback(35000, this, 0);
}

void
UI_BeOS3::processEvents(void)
{
}

void
UI_BeOS3::init(int *argc, char ***argv)
{
