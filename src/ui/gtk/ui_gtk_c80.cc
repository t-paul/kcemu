...
UI_Gtk_C80::UI_Gtk_C80(void) : UI_Gtk()
{
  reset();
...
void
UI_Gtk_C80::callback(void *data)
{
  z80->addCallback(C80_CB_OFFSET, this, 0);
  update();
}

int
UI_Gtk_C80::get_width(void)
{
  return kcemu_ui_scale * get_real_width();
}

int
UI_Gtk_C80::get_height(void)
{
  return kcemu_ui_scale * get_real_height();
}

const char *
UI_Gtk_C80::get_title(void)
{
  return _("C-80 Emulator");
}

void
UI_Gtk_C80::allocate_colors(double saturation_fg,
...
void
UI_Gtk_C80::init(void)
{
}

void
UI_Gtk_C80::update(bool full_update, bool clear_cache)
{
...
void
UI_Gtk_C80::flash(bool enable)
{
}

void
UI_Gtk_C80::memory_read(word_t addr)
{
}

void
UI_Gtk_C80::memory_write(word_t addr)
{
}

int
UI_Gtk_C80::get_mode(void)
{
  return generic_get_mode();
}

void
UI_Gtk_C80::set_mode(int mode)
{
...
void
UI_Gtk_C80::reset(bool power_on)
{
  z80->addCallback(C80_CB_OFFSET, this, 0);
}
