...
#ifndef __ui_ui_gtk_kramermc_h
#define __ui_ui_gtk_kramermc_h

#include "ui/gtk/ui_gtk.h"

#include "ui/generic/ui_kramermc.h"

class UI_Gtk_KramerMC : public UI_Gtk, public UI_KramerMC
{
 private:
  enum {
    KRAMERMC_CB_OFFSET = 30000
  };

 public:
  UI_Gtk_KramerMC(void);
