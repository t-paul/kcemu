...
#ifndef __ui_ui_gtk_vcs80_h
#define __ui_ui_gtk_vcs80_h

#include "ui/gtk/ui_gtk.h"

#include "ui/generic/ui_vcs80.h"

class UI_Gtk_VCS80 : public UI_Gtk, public UI_VCS80
{
 private:
  enum {
    VCS80_CB_OFFSET = 25000,
    VCS80_LED_CB_OFFSET = 4000,
  };

 public:
  UI_Gtk_VCS80(void);
  virtual ~UI_Gtk_VCS80(void);
