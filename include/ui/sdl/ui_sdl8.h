 ...
 *
 *  $Id: ui_sdl8.h,v 1.2 2002/10/31 01:16:25 torsten_paul Exp $
 *
...
#ifndef __ui_sdl_ui_sdl8_h
#define __ui_sdl_ui_sdl8_h

#include "ui/sdl/ui_sdl.h"

#include "ui/generic/ui_8.h"

class UI_SDL8 : public UI_SDL, public UI_8
{
 public:
  UI_SDL8(void);
  virtual ~UI_SDL8(void);
