 ...
 *
 *  $Id: ui_sdl1.h,v 1.2 2002/10/31 01:16:25 torsten_paul Exp $
 *
...
#ifndef __ui_sdl_ui_sdl1_h
#define __ui_sdl_ui_sdl1_h

#include "ui/sdl/ui_sdl.h"

#include "ui/generic/ui_1.h"

class UI_SDL1 : public UI_SDL, public UI_1
{
 public:
  UI_SDL1(void);
  virtual ~UI_SDL1(void);
