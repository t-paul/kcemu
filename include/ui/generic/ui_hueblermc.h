...
#ifndef __ui_generic_ui_hueblermc_h
#define __ui_generic_ui_hueblermc_h

#include "kc/system.h"

#include "ui/generic/ui_base.h"

class UI_HueblerMC : public UI_Base
{
 protected:
  int     _mode;
  byte_t *_font;
