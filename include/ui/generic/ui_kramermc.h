...
#ifndef __ui_generic_ui_kramermc_h
#define __ui_generic_ui_kramermc_h

#include "kc/system.h"

#include "ui/generic/ui_base.h"

class UI_KramerMC : public UI_Base
{
 protected:
  byte_t *_font;
  byte_t *_pix_cache;
