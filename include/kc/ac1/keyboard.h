...
#ifndef __kc_ac1_keyboard_h
#define __kc_ac1_keyboard_h
...
class KeyboardAC1 : public Keyboard, public PIOCallbackInterface
{
 private:
  int _key;
  bool _control;
