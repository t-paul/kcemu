...
#ifndef __kc_muglerpc_ctc_h
#define __kc_muglerpc_ctc_h

#include "kc/system.h"

#include "kc/ctc_base.h"

class CTCMuglerPCSystem : public CTC_Base
{
 public:
  CTCMuglerPCSystem(void);
  virtual ~CTCMuglerPCSystem(void);
...
class CTCMuglerPCUser : public CTC_Base
{
 public:
  CTCMuglerPCUser(void);
  virtual ~CTCMuglerPCUser(void);
