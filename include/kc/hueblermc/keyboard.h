...
#ifndef __kc_hueblermc_keyboard_h
#define __kc_hueblermc_keyboard_h

#include "kc/kc.h"
#include "kc/ports.h"
#include "kc/keyboard.h"

class KeyboardHueblerMC : public Keyboard, public PortInterface
{
 private:
  int _key;
 ...
 public:
  KeyboardHueblerMC(void);
  virtual ~KeyboardHueblerMC(void);
  ...
  virtual word_t irqack();
  virtual void reset(bool power_on);
};

#endif /* __kc_hueblermc_keyboard_h */
