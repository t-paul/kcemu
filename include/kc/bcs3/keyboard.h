...
#ifndef __kc_bcs3_keyboard_h
#define __kc_bcs3_keyboard_h
...
class KeyboardBCS3 : public Keyboard, public PIOCallbackInterface
{
 private:
  int _key;
  bool _shift;
 ...
 public:
  ...
  virtual byte_t memory_read(word_t addr);
