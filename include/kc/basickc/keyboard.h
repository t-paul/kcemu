...
#ifndef __kc_basickc_keyboard_h
#define __kc_basickc_keyboard_h

#include "kc/kc.h"
#include "kc/ports.h"
#include "kc/keyboard.h"

class KeyboardBasicKC : public Keyboard, public PortInterface
{
 private:
  int _key;
 ...
 public:
  KeyboardBasicKC(void);
  virtual ~KeyboardBasicKC(void);
