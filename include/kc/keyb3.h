 ...
 *
 *  $Id: keyb3.h,v 1.7 2002/01/20 13:39:29 torsten_paul Exp $
 *
 ...
 *
 *  bit 0 = 5.120 ms = 5 * 64 * 16탎
 *  bit 1 = 7.168 ms = 7 * 64 * 16탎
 *
 *  Tw  = 14.336 ms = 14 * 64 * 16탎 (time between repeated words)
 *  Tdw = 19.456 ms = 19 * 64 * 16탎 (time between double words)
 *
 ...
 *
 *  1 cycle is 1/1750000 seconds = 0.0005714 ms = 0.5714 탎
 *
