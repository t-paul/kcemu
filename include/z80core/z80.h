...
typedef struct
{
  reg_pair AF,BC,DE,HL,IX,IY,PC,SP;   /* Main registers      */
  reg_pair AF1,BC1,DE1,HL1;           /* Shadow registers    */
...
/************************************ TO BE WRITTEN BY USER **/
void PatchZ80(register _Z80 *R);

/** RetiZ80() ************************************************/
/** Signal a RETI instruction.                              **/
/************************************ TO BE WRITTEN BY USER **/
void RetiZ80(void);
